...
function fromRow(row: FacturaRow): Factura {
  ...
  // El helper consolidado vive en `dominio/shared/codigos` desde el change
  // `factura-compliance-hardening` (antes triplicado en este archivo,
  // `factura.ts` y el adapter Expo).
