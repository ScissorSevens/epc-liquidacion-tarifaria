...
interface Props {
  ...
  readonly repo: {
    guardar: (a: Omit<AcuerdoMunicipal, 'id_acuerdo' | 'created_at'>) => Promise<AcuerdoMunicipal>;
  };
}
...
export default function AcuerdoMunicipalForm({ id_prestador, acuerdoActual, repo }: Props) {
